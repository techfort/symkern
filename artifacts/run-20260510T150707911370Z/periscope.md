...
Run `run-20260510T150707911370Z` converged with status `success`. The machine artifact contains 4 nodes and invented abstractions: invented.detect_stream_anomaly.
