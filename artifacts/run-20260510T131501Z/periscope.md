...
Run `run-20260510T131501Z` converged with status `success`. The machine artifact contains 5 nodes and invented abstractions: invented.detect_stream_anomaly.
...
- [execute] Executed core.score_delta.
- [execute] Executed core.compare_threshold.
